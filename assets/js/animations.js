/* ✅ NEW FILE: /assets/js/site-animations.js
   This is your previous inline script moved out of the HTML.
   It still works because:
   - It runs on DOMContentLoaded (defer)
   - It "retries" GSAP init until CDN scripts are ready
   - It targets the same selectors
   - It positions stickers in an overlay layer so they never affect text layout
*/
(() => {
  "use strict";
